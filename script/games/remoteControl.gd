...
func _on_menu_control(directive: String):
	...
	match directive:
		"up", "down", "left", "right":
			print("[MenuController] Emitting navigate: ", directive)
			navigate.emit(directive)
		"enter":
			print("[MenuController] Emitting enter_pressed")
			enter_pressed.emit()
		"back", "homepage":
			print("[MenuController] Emitting back_pressed signal for directive: ", directive)
			back_pressed.emit()
		"volume_up":
